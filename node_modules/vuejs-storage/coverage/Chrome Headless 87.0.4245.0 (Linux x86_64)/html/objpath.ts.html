...
<head>
    <title>Code coverage report for objpath.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> objpath.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export function parsePath(path: string): string[] {
	return path
		.replace(/\[([^[\]]*)\]/g, '.$1.')
		.split('.')
		.filter(t =&gt; t !== '')
