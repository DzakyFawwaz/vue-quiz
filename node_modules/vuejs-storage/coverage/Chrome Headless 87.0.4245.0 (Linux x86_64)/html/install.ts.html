...
<head>
    <title>Code coverage report for install.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> install.ts</h1>
        <div class='clearfix'>
...
export function install(Vue: VueConstructor) {
	Vue.mixin({
		created() {
			<span class="missing-if-branch" title="else path not taken" >E</span>if ('storage' in this.$options) {
